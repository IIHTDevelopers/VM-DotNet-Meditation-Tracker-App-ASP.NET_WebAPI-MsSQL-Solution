...
namespace MeditationTrackerApp
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            // Register your dependencies, including IMeditationService
            container.RegisterType<IMeditationTrackerService, MeditationTrackerService>();
            container.RegisterType<IMeditationTrackerRepository, MeditationTrackerRepository>();
